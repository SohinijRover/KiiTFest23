  ...
  return (
    <div className="flex justify-between items-center p-3 bg-transparent">
      ...
      <ul className="hidden lg:flex font-lato text-white justify-center items-center gap-6 ml-auto p-4">
        <li>
          <Link href="/">
            <a className="p-4 uppercase duration-200 hover:text-thPink cursor-pointer">About</a>
          </Link>
        </li>
        <li>
          <Link href="/Events">
            <a className="p-4 uppercase duration-200 hover:text-thPink cursor-pointer">Event</a>
          </Link>
        </li>
        <li>
          <Link href="/Members">
            <a className="p-4 uppercase duration-200 hover:text-thPink cursor-pointer">Members</a>
          </Link>
        </li>
        <li>
